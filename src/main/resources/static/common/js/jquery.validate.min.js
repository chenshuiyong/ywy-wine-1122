    ...
    t.extend(t.validator, {
        ...
        prototype: {
            ...
            showLabel: function(e, i) {
               ...
               /* s.length ? (s.removeClass(this.settings.validClass).addClass(this.settings.errorClass), s.html(i)) : (s = t("<" + this.settings.errorElement + ">").attr("for", this.idOrName(e)).addClass(this.settings.errorClass).html(i || ""), this.settings.wrapper && (s = s.hide().show().wrap("<" + this.settings.wrapper + "/>").parent()), this.labelContainer.attrappend(s).length || (this.settings.errorPlacement ? this.settings.errorPlacement(s, t(e)) : s.insertAfter(e))),
				...
				//alert(this.idOrName(e)+i);
                if(!jQuery('#'+this.idOrName(e)).attr('cache')){
                	jQuery('#'+this.idOrName(e)).attr('cache',jQuery('#'+this.idOrName(e)).attr('placeholder'));
                }
                var placeholder=jQuery('#'+this.idOrName(e)).attr('cache');
				jQuery('#'+this.idOrName(e)).attr('placeholder',placeholder+"*"+i);
				if(this.idOrName(e)=='mobile'&&jQuery('#'+this.idOrName(e)).val().length>=11){
					jQuery('#'+this.idOrName(e)).val('');
				}
				
				//jQuery("input[name='"+this.idOrName(e)+"']").attr('placeholder',i);
            },

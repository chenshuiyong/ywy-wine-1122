                ...
                $(Obj).bind("click", function(e) {
                    ...
                    for( i = 0; i < options.emotions.length; i++) {
                       // faceHtml += '<li text=' + options.emotions[i].phrase + ' type=' + i + '><img title=' + options.emotions[i].phrase + ' src="'+ options.emotions[i].url + '"  style="cursor:pointer; position:relative;"   /></li>';
						faceHtml += '<li text=' + options.emotions[i].phrase + ' type=' + i + '><img title=' + options.emotions[i].phrase + ' src="'+ JS_ROOT_PATH +"images/" + options.emotions[i].url + '"  style="cursor:pointer; position:relative;"   /></li>';
                    }
                    faceHtml += '</ul></div>';
                        ...
                        for( n = 0; n < em.length; n++) {
                            if(em[n].phrase == rs[i]) {
                               // var t = "<img src='"  + em[n].url + "' />";
							    var t = "<img src='"  + JS_ROOT_PATH +"images/"+ em[n].url + "' />";
